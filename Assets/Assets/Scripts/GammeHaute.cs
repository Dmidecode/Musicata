...
public class GammeHaute : SpawnerNote
{
  ...
  private void Start()
  {
    ...
    positionGameHaute = positionGameNormal + gammeTon;
  }
  ...
  {
    note.transform.position = new Vector3(startPositionMesure.x + positionNoteToCm[positionDansMesure], positionGameHaute, startPositionMesure.z);
  }

  public override void Re(GameObject note, Vector3 startPositionMesure, int positionDansMesure)
  {
    note.transform.position = new Vector3(startPositionMesure.x + positionNoteToCm[positionDansMesure], positionGameHaute + ton, startPositionMesure.z);
  }

  public override void Mi(GameObject note, Vector3 startPositionMesure, int positionDansMesure)
  {
    note.transform.position = new Vector3(startPositionMesure.x + positionNoteToCm[positionDansMesure], positionGameHaute + ton * 2, startPositionMesure.z);
  }

  public override void Fa(GameObject note, Vector3 startPositionMesure, int positionDansMesure)
  {
    note.transform.position = new Vector3(startPositionMesure.x + positionNoteToCm[positionDansMesure], positionGameHaute + ton * 3, startPositionMesure.z);
  }

  public override void Sol(GameObject note, Vector3 startPositionMesure, int positionDansMesure)
  {
    note.transform.position = new Vector3(startPositionMesure.x + positionNoteToCm[positionDansMesure], positionGameHaute + ton * 4, startPositionMesure.z);
  }

  public override void La(GameObject note, Vector3 startPositionMesure, int positionDansMesure)
  {
    note.transform.position = new Vector3(startPositionMesure.x + positionNoteToCm[positionDansMesure], positionGameHaute + ton * 5, startPositionMesure.z);
  ...
  {
    note.transform.position = new Vector3(startPositionMesure.x + positionNoteToCm[positionDansMesure], positionGameHaute + ton * 6, startPositionMesure.z);
